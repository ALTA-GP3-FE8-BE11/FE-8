      ...
      <div style={{ backgroundColor: '#DCDCDC' }}>
        <div className="container p-2">
          ...
          <div className="container mt-1" >
            <Row className="p-5">
              <Col md={6} className="bg-white" style={{ borderRadius: '10px', height:'450px' }}>
                <Row className="pt-3">
                ...
                <Row style={{ marginLeft: '40px', marginTop: '25px', paddingTop:'20px' }}>
                  <h2> NIKE </h2>
                  <hr />
                ...
                <Row className="d-flex justify-content-center pt-5">
                  <Button className="w-50 mb-2" variant="secondary">Tambah</Button>
                </Row>
                <Row className="d-flex justify-content-center">
                  <Button className="w-50 d-flex justify-content-center" variant="secondary">Beli</Button>
                </Row>
              </Col>
